...
public:
	...
	{ 
		...
		InterlockedExchange64(&retPacket->_dlLanHeaderExist, false);
	...
	bool AlreadyLANHeader() { return (bool)_dlLanHeaderExist; }
...
private:
	...
	void PutLANHeader(char* chpSrc, int iSrcSize);
	void PutWANHeader(char* chpSrc, int iSrcSize);
...
private:
	...
	LONG64 alignas(64) _dlLanHeaderExist;
