...
// Return: (int)복사한 사이즈.
//////////////////////////////////////////////////////////////////////////
void CPacket::PutLANHeader(char* chpSrc, int iSrcSize)
{
	if (true == (bool)InterlockedExchange64(&_dlLanHeaderExist, true))
		return;
...
// Return: (int)복사한 사이즈.
//////////////////////////////////////////////////////////////////////////
void CPacket::PutWANHeader(char* chpSrc, int iSrcSize)
{
